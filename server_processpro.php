<?php
	...
	*/
	...
	$aColumnas = array( 'id', 'nombre', 'grupo','correo','horario' ,'profesor',);
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificarpro.php?id=".$aRow['id']."'><span class='glyphicon glyphicon-pencil'></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminarpro.php?id=".$aRow['id']."' data-toggle='modal' data-target='#confirm-delete'><span class='glyphicon glyphicon-trash'></span></a></td>";
